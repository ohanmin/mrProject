 ...
 * Mapper 파일의 앞의 2개 데이터 타입(LongWritable, Text)은 북석할 파일의 키과 값의 데이터 타입
 * Mapper 파일의 뒤의 2개 테이터 타입(Text, IntWritable)은 리듀스에 보낼 키와 값의 데이터 타입
 */
public class IPCount2Mapper extends Mapper<LongWritable, Text, Text, IntWritable> {
    ...
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException{
        ...
        int forCnt = 0; //반복 횟수
        //단어 빈도수 구현은 단어가 아닌 것을 기분으로 단어로 구분함
